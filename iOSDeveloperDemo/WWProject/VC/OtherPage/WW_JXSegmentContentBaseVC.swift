//
//  WW_JXSegmentContentBaseVC.swift
//  iOSDeveloperDemo
//
...
import CoreAudio
class WW_JXSegmentContentBaseVC: WW_MainBaseVC {
...
//        }
    ...
    override func viewDidLayoutSubviews() {
        ...
        listContainerView.frame = CGRect(x: 0, y: 325, width: view.bounds.size.width, height: view.bounds.size.height - 325)
    }
...
extension WW_JXSegmentContentBaseVC: JXSegmentedViewDelegate {
...
extension WW_JXSegmentContentBaseVC: JXSegmentedListContainerViewDataSource {
    ...
    func listContainerView(_ listContainerView: JXSegmentedListContainerView, initListAt index: Int) -> JXSegmentedListContainerViewListDelegate {
        let vc = WW_FamousSayingVC()
        vc.vcTitle = ["总监英雄榜", "名言堂"][index]
        return vc
    }
}
