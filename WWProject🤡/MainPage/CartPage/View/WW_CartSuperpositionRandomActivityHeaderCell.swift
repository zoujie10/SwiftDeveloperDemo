//
//  WW_CartSuperpositionRandomActivityHeaderCell.swift
//  iOSDeveloperDemo
//
...
class WW_CartSuperpositionRandomActivityHeaderCell: UITableViewCell {
    var activitySubView = WW_CartRandomActivityCellSubview()
...
class WW_CartRandomActivityCellSubview:UIView{
